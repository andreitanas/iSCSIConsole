...
namespace Utilities
{
    public abstract class FileSystem : IFileSystem
    {
        ...
        public void CopyFile(string sourcePath, string destinationPath)
        {
            ...
            using (Stream destinationStream = OpenFile(destinationPath, FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite))
            {
                sourceStream.CopyTo(destinationStream, bufferLength);
            }
        }
